...
import com.example.my.baidu.NewActivity;
import com.example.my.baidu.R;
import com.example.my.baidu.other.ImageLoader;
import com.example.my.baidu.other.Images;
 ...
 * @author guolin
 */
public class MyScrollView extends ScrollView implements OnTouchListener ,View.OnClickListener{
